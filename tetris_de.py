...
"""
10 x 20 square grid (x, y)
shapes: S, Z, I, O, J, L, T (with the 4 rotations)
...
def draw_next_shape(shape, surface):
    ...
    #Position of "Next Shape Pic & Text"
...
def draw_window(surface, score=0):
    surface.fill((0,0,0))
    # Tetris Title
    font = pygame.font.SysFont('inkfree', 45)
    label = font.render('TETRIS by BRiGHTeSS', 1, (255,255,255))
 
    surface.blit(label, (top_left_x + play_width / 2 - (label.get_width() / 2), 30))

    # Position Of "Score text" (current score)
    font = pygame.font.SysFont('candara', 30)
...
def main():
    ...
    while run:
        ...
        if change_piece:
            ...
            score += clear_rows(grid, locked_positions) * 100 # if clear 1 row get the 100 point
    ...
    draw_text_middle("You Lost, nice try", 80, (255,255,255), win)
    pygame.display.update()
